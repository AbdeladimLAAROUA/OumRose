...
<meta name="viewport" content="width=device-width, initial-scale=1">
    <meta property="og:title" content="Checklist équipement sorties et voyages avec bébé">
    <meta property="og:image" content="http://beta.oumbox.com/img/thumbnail/sortie%20bb.jpg">
    <meta property="og:url" content="http://beta.oumbox.com/blogContent-bb2.php">
    <meta property="og:description" content="Checklist équipement sorties et voyages avec bébé">
    ...
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="slick_slider">
          <div class="single_iteam">  <img src="img/sortie bb.jpg" alt="">
          </div>
        </div>
      </div>
  ...
  <section id="contentSection">
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-8 content">
        <h2>Checklist équipement sorties et voyages avec bébé</h2>

      
      
        <ul>
         <li>Poussette, ombrelle et habillage pluie</li>
         <li>Porte bébé</li>
         <li>Sac à langer</li>
         <li>Siège auto adapté à l’âge et au poids de votre enfant</li>
         <li>Lit parapluie</li>
         <li>Matelas pliant</li>
         <li>Moustiquaire</li>
         <li>Sac isotherme</li>
         ...
         <li>Trousse de soin</li>
          ...
          <p>
          Si vous allez à l'hotel avec votre bébé, pensez à appeler la réception pour connaitre quels équipements pour bébé ils peuvent mettre à votre disposition.
          </p>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-4">

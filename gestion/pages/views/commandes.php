      ...
      <div class="box">
        ...
        <div class="box-body">
           <div style="margin-bottom:20px;">
            <button id="export_all_cmd" type="button" class="btn btn-success"><span class="glyphicon glyphicon-download-alt"></span> Export</button>
          </div>
          <table id="table_commandesAll" class="table table-bordered table-striped">
            <thead>
            <tr>
              <th>Id Maman</th>
              <th>Id Commande</th>
...
<div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="delete" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="alert alert-danger"><span class="glyphicon glyphicon-warning-sign"></span> Êtes-vous sûr de vouloir supprimer cette commande</div>

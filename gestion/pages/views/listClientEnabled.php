...
<div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
        <h4 class="modal-title custom_align" id="Heading">Créer un nouveau client <span style="color: red;">(box 2 sera automatiquement commandée)</span></h4>
      </div>
      <div class="modal-body">
...
if ($_SESSION['role_a'] == 'mgr') {
    echo '<script src="dist/js/list_2.js"  data-role="mgr" data-list="1"></script>';
} else if ($_SESSION['role_a'] == 'admin') {
    echo '<script src="dist/js/list_2.js"  data-role="admin" data-list="1"></script>';
} else {
    echo '<script src="dist/js/list_2.js"  data-role="user" data-list="1"></script>';
}
?>

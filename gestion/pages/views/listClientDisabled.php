        ...
        <div class="box-body">
          <div style="margin-bottom:20px;">
            ...
            <!--<div id="searchParams">
                ...
                <button class="btn addFilterBtn">Ajouter un filtre</button>
                <button class="btn searchBtn">Rechercher</button>
            </div>-->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="createUserForm">
          ...
          <div class="row">
            <div class="col-xs-12">
              <button type="submit" class="btn btn-primary btn-lg" style="width: 100%;margin-bottom: 10px;"><span class="glyphicon glyphicon-ok-sign"><span
                              class="glyphicon glyphicon-ok-sign"></span>Créer (box 2 sera automatiquement commandée)Créer</button>
            </div>
          </div>
        </form>
      </div>
...
<?php
/*data-list 0 : membre désactivé
data-list 1 : membre activé*/
if ($_SESSION['role_a'] == 'mgr') {
    echo '<script src="dist/js/list_2.js"  data-role="mgr" data-list="0"></script>';
} else if ($_SESSION['role_a'] == 'admin') {
    echo '<script src="dist/js/list_2.js"  data-role="admin" data-list="0"></script>';
} else {
    echo '<script src="dist/js/list_2.js"  data-role="user" data-list="0"></script>';
}
?>

...
<meta property="og:title" content="Checklist toilette & change">
<meta property="og:image" content="http://beta.oumbox.com/img/bebe-change.jpeg">
<meta property="og:url" content="http://beta.oumbox.com/blogContent-bb1.php">
    ...
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="slick_slider">
          <div class="single_iteam"> <img src="img/bebe-change.jpeg" alt="">
          </div>
        </div>
      </div>
  ...
  <section id="contentSection">
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-8 content">
        <h2>Checklist toilette & change</h2>

       
        <ul>
          <li>Table à langer</li>
          <li>Baignoire</li>
          <li>Support baignoire</li>
          <li>Transat de bain</li>
          <li>Transat de bain</li>
          <li>Jouet de bain</li>
          <li>Jouet de bain</li>
          <li>Ciseaux à bout rond</li>
          <li>Brosse</li>
          <li>Brosse</li>
          <li>Thermomètre</li>
          <li>Couches</li>
          <li>Crème pour le siège</li>

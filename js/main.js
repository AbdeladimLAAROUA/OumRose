;(function () {
	...
	var features5Animate = function() {
		if ( $('#fh5co-features-5').length > 0 ) {	
			$('#fh5co-features-5 .to-animate').each(function( k ) {
	...
	var features5WayPoint = function() {
		if ( $('#fh5co-features-5').length > 0 ) {
			$('#fh5co-features-5').waypoint( function( direction ) {
				...
				if( direction === 'down' && !$(this).hasClass('animated') ) {
					...
					setTimeout(function(){
						$('.features5-animate-1').addClass('fadeIn animated');
					}, 200);

					setTimeout(function(){
						$('.features5-animate-2').addClass('fadeIn animated');
					}, 400);

					setTimeout(features5Animate, 800);
	...
	var features6Animate = function() {
		if ( $('#fh5co-features-6').length > 0 ) {	
			$('#fh5co-features-6 .to-animate').each(function( k ) {
	...
	var features6WayPoint = function() {
		if ( $('#fh5co-features-6').length > 0 ) {
			$('#fh5co-features-6').waypoint( function( direction ) {
				...
				if( direction === 'down' && !$(this).hasClass('animated') ) {
					...
					setTimeout(function(){
						$('.features6-animate-1').addClass('fadeIn animated');
					}, 200);

					setTimeout(function(){
						$('.features6-animate-2').addClass('fadeIn animated');
					}, 400);

					setTimeout(features6Animate, 800);

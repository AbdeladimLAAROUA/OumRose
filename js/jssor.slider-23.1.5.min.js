(function(i, g, c, h, e, k, f) { /*! Jssor */
    ...
    var b = i.$Jssor$ = new function() {
        ...
        j.ig = function(a, b) {
            ...
            b & 2 && j.z(a, (j.$CssHeight(c) - j.$CssHeight(a)) / 2)
        };
        j.cc = function(b, a) {
        ...
        j.od = function(n, j, s, t, B, C, o) {
            ...
            if (n) {
                ...
                if (w) {
                    ...
                    if (r() && l >= 11 && (j.v || j.D) && s != 0 && s != 1) a.$Rotate = a.$Rotate || 1e-8;
                    a.ef = e
                }
            }
            if (j.$Clip && o.$Move) {
            ...
            if (a.$Clip && b.Uf() && !a.$Clip.$Top && !a.$Clip.$Left && !a.$Clip.D && !a.$Clip.v && a.$Clip.$Right == o.$OriginalWidth && a.$Clip.$Bottom == o.$OriginalHeight) a.$Clip = h;
            return a
        }
    };
                    ...
                    if (I) {
                        ...
                        if (a.$Clip) {
                            ...
                            if (B && A) {
                                h.$Left = g.U / 2 * w;
                                h.$Right = -h.$Left
                            } else if (B) h.$Right = -g.U * w;
                            else if (A) h.$Left = g.U * w
                        }
                        s.$Clip = u;
                        f.$Clip = g[t]
                    }
    ...
    var j = i.$JssorSlider$ = function(q, hc) {
        ...
        function Ec() {
            ...
            b.oc = function(d, b) {
                ...
                if (f != b && b > d) f++;
                Xb(f, e);
                a.m(j.$EVT_POSITION_CHANGE, v(b), v(d), b, d)
            }
        }
        ...
        function rc(n, m) {
            ...
            b.jd = function() {
                Q = e;
                S = h;
                a.m(j.$EVT_SWIPE_START, v(x.Z()), x.Z())
            };
            b.ld = function() {
                Q = k;
                i = k;
                var b = x.og();
                a.m(j.$EVT_SWIPE_END, v(x.Z()), x.Z());
                !b.yb && Gc(b.mg, r)
            };
            b.oc = function(h, e) {
                var a;
        ...
        function Ac(i, f) {
            ...
            function F(a) {
                ...
                T(i, a, 0);
                D = e;
                q = new I.$Class(i, I, b.Vf(b.$AttributeEx(i, "idle")) || qc, !u);
                q.L(0)
            }
                ...
                b.$Each(i, function(f) {
                    ...
                    if (j == "caption") {
                        if (d) {
                            ...
                            K && b.$AttributeEx(f, "3d") && b.Bf(f, "preserve-3d")
        ...
        function yc(z, g, p, q) {
            ...
            function w() {
                b.uc(K);
                fc && m && o.ne && b.$AppendChild(K, o.ne);
                b.u(K, !m && o.Zb)
            }
            ...
            c.qe = function(a) {
                p && b.nb(ib, a && p.Nc.$Outside ? "" : "hidden")
            };
            c.Kc = function(c, b) {
                if (m && b >= h) {
                    m = k;
        ...
        function ac(c, d) {
            ...
            if (!O && !b.$AttributeEx(l, "nodrag") && wc() && (!d || c.touches.length == 1)) {
                ...
                Bb = k;
                S = h;
                b.$AddEvent(g, d ? "touchmove" : "mousemove", Eb);
                b.V();
                J = 0;
                ic();
                if (!qb) y = 0;
        ...
        function Eb(d) {
            if (D) {
                ...
                if (f) {
                    var j = f.x - wb,
                        k = f.y - xb;
                    if (c.floor(G) != G) y = y || hb & O;
                    if ((j || k) && !y) {
                        if (O == 3)
                            if (c.abs(k) > c.abs(j)) y = 2;
                            else y = 1;
                        else y = O;
                        if (lb && y == 1 && c.abs(k) - c.abs(j) > 3) Bb = e
                    }
                    if (y) {
                        var a = k,
                            i = Db;
        ...
        function nb() {
            ...
            if (D) {
                ...
                A.rb();
                var c = x.Z();
                a.m(j.$EVT_DRAG_END, v(c), c, v(G), G);
                E & 12 && Sb();
                gc(e)
            }
        }
        ...
        a.$ScaleWidth = a.$SetScaleWidth = a.$GetScaleWidth = Ib;
        a.Yd = function(a) {
            var d = c.ceil(v(gb / dc)),
                b = v(a - P + d);
            if (b > w) {
                if (a - P > s / 2) a -= s;
                else if (a - P <= -s / 2) a += s
        ...
        var rb = o.$BulletNavigatorOptions,
            ...
            Lb = b.$FindChild(q, "navigator", R),
            ec = b.$FindChild(q, "arrowleft", R),
            cc = b.$FindChild(q, "arrowright", R),
            Jb = b.$FindChild(q, "thumbnavigator", R),
            pc = b.$CssWidth(t),
            oc = b.$CssHeight(t),
            W, U = [],
            xc = b.$Children(t);
        ...
        var r = -1,
            ...
            w = c.min(o.$Cols, s),
            ib, y, O, Bb, T = [],
            Tb, Vb, Rb, fc, Fc, u, kb = o.$AutoPlaySteps,
            E = o.$PauseOnHover,
            ...
            Q, D, S, wb = 0,
            xb = 0,
            H, cb, fb, Fb, x, V, A, Wb = new sc,
            ab, Ob = [];
        if (s) {
            if (o.$HWA) Nb = function(a, c, d) {
                b.ub(a, {
                    $TranslateX: c,
                    $TranslateY: d
                })
            ...
            if (eb) {
                fc = eb.$ShowLink;
                sb = eb.$Class;
                vb = w == 1 && s > 1 && sb && (!b.$IsBrowserIE() || b.$BrowserVersion() >= 8)
            }
            gb = vb || w >= s || !(N & 1) ? 0 : o.$Align;
            Z = (w > 1 || gb ? hb : -1) & o.$DragOrientation;
            var B = [],
                C, K, Gb = b.$Device(),
                lb = Gb.Ge,
                G, qb, Mb, tb;
            Gb.re && b.$Css(t, Gb.re, ([h, "pan-y", "pan-x", "none"])[Z] || "");
            V = new Cc;
            if (vb) C = new sb(Wb, M, L, eb, lb);
            ...
            b.$AddEvent(q, "mouseout", b.hc(lc, q));
            b.$AddEvent(q, "mouseover", b.hc(kc, q));
            if (Z) {
                b.$AddEvent(t, "mousedown", ac);
                b.$AddEvent(t, "touchstart", vc);
                b.$AddEvent(t, "dragstart", Kb);
                b.$AddEvent(t, "selectstart", Kb);
            ...
            E &= lb ? 10 : 5;
            if (Lb && rb) {
                Tb = new rb.$Class(Lb, rb, Y(), jb());
                T.push(Tb)
            }
            if (X && ec && cc) {
                X.$Loop = N;
                X.$Cols = w;
                Vb = new X.$Class(ec, cc, X, Y(), jb());
                T.push(Vb)
            }
            if (Jb && bb) {
                bb.$StartIndex = o.$StartIndex;
                Rb = new bb.$Class(Jb, bb);
                T.push(Rb)
            }
            b.$Each(T, function(a) {
                a.xc(s, B, db);

    ...
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="slick_slider">
          <div class="single_iteam"> <img src="img/sac à langer.jpg" alt="">
          </div>
        </div>
      </div>
  ...
  <section id="contentSection">
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-8 content">
        <h2>Checklist sac à langer</h2>

        <p>Vérifiez le contenu du sac à langer avant chaque sortie :</p>
       
        <ul>
         <li>4 à 5 couches pour être large à adapter en fonction de la durée du déplacement</li>
         <li>Cotton et eau nettoyante</li>
         <li>Tapis à langer</li>
         <li>Une tenue de rechange complète (prévoir deux body au cas où)</li>
         <li>Sérum physiologique et compresses</li>
         <li>Eosine mono dose</li>
         <li>Sacs en plastique pour couches sales et tenue de bébé sale</li>
         <li>Un jouet</li>
         <li>Tétine si utilisée</li>
         <li>Le nécessaire pour le repas (biberon, dosette de lait, eau, compote, yagourt, cuillère)</li>
         <li>Biberon d’eau</li>
         <li>Bavoirs et serviette</li>
         <li>Un paquet de mouchoir (ça sert toujours)</li>
         <li>Bonnet ou chapeau en fonction de la saison</li>
         <li>Couverture polaire en hiver</li>
         <li>Crème solaire en été</li>
         <li>Eventuellement le carnet de santé et une feuille de mutuelle (on l'oublie toujours!)</li>
        </ul>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-4">

	...
	<!--end: Header-->
		<div class="section1">
			...
			<section class="content askForBox">
				<h2>Demanez votre box maintenant</h2>
				<div class="box">
					<img src="img/guide1box.png" class="imgBox" alt="box1">
					<img src="img/guide2box.png" class="imgBox" alt="box1">
					<img src="img/guide3box.png" class="imgBox" alt="box1">
					<div class="intro">
				...
				<input type="submit" value="Envoyer" class="btn btn-rose">
				</form>
			</section>

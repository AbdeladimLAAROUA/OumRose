    ...
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="slick_slider">
          <div class="single_iteam"> <a href="blogContent-bb8.php"> <img src="img/bb dort.jpg" alt=""></a>
            <div class="slider_article">
              <h2><a class="slider_tittle" href="blogContent-bb8.php">Le sommeil de bébé</a></h2>
              <p>
          Chaque enfant est unique. Respectez son individualité. Aucun enfant ne correspondra exactement au schéma général du comportement attendu à un certain âge ou à un degré de développement...
        </p>
            </div>
          </div>
          <div class="single_iteam"> <a href="blogContent-bb7.php"> <img src="img/allaitement.jpg" alt=""></a>
            <div class="slider_article">
              <h2><a class="slider_tittle" href="blogContent-bb7.php">Quelle alimentation pour mon bébé?</a></h2>
              <p></p>
            </div>
          </div>
          <div class="single_iteam"> <a href="blogContent-bb6.php"> <img src="img/jeux-eveil.jpg" alt=""></a>
            <div class="slider_article">
              <h2><a class="slider_tittle" href="blogContent-bb6.php">Quel jouet pour quel âge?</a></h2>
              <p></p>
            </div>
          </div>
          <div class="single_iteam"> <a href="blogContent-bb5.php"> <img src="img/security.jpg" alt=""></a>
            <div class="slider_article">
              <h2><a class="slider_tittle" href="blogContent-bb5.php">Checklist sécurité de bébé à la maison</a></h2>
              <p> Mettez-vous à la place d'un bébé qui rampe ou qui commence à marcher, et vous serez effrayée de voir les dangers qui l'entourent. Alors équipez-vous, et surtout, ne laissez...</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="single_post_content">
            ...
            <div class="single_post_content_left">
              <ul class="business_catgnav  wow fadeInDown">
                <li>
                  <figure class="bsbig_fig"> <a href="blogContent-bb8.php" class="featured_img"> <img alt="" src="img/bb dort.jpg"> <span class="overlay"></span> </a>
                    <figcaption> <a href="blogContent-bb8.php">Le sommeil de bébé</a> </figcaption>
                    <p class="catBlogDescrition">Chaque enfant est unique. Respectez son individualité. Aucun enfant ne correspondra exactement au schéma général du comportement attendu à un certain âge ou à un degré de développement. Il est donc impossible de prétendr…</p>
                  </figure>
                </li>
              </ul>
            </div>
            <div class="single_post_content_right">
              <ul class="spost_nav">
                <li>
                  <div class="media wow fadeInDown"> <a href="blogContent-bb7.php" class="media-left"> <img alt="" src="img/allaitement.jpg"> </a>
                    <div class="media-body"> <a href="blogContent-bb7.php" class="catg_title">Quelle alimentation pour mon bébé?</a> </div>
                  </div>
                </li>
                <li>
                  <div class="media wow fadeInDown"> <a href="blogContent-bb6.php" class="media-left"> <img alt="" src="img/jeux-eveil.jpg"> </a>
                    <div class="media-body"> <a href="blogContent-bb6.php" class="catg_title">Quel jouet pour quel âge?</a> </div>
                  </div>
                </li>
                <li>
                  <div class="media wow fadeInDown"> <a href="blogContent-bb5.php" class="media-left"> <img alt="" src="img/security.jpg"> </a>
                    <div class="media-body"> <a href="blogContent-bb5.php" class="catg_title">Checklist sécurité de bébé à la maison</a> </div>
                  </div>
                </li>
                <li>
                  <div class="media wow fadeInDown"> <a href="blogContent-bb4.php" class="media-left"> <img alt="" src="img/sac à langer.jpg"> </a>
                    <div class="media-body"> <a href="blogContent-bb4.php" class="catg_title">Checklist sac à langer</a> </div>
                  </div>
                </li>
                <li>
      ...
      <div class="col-lg-4 col-md-4 col-sm-4">
        <aside class="right_content">
          <div class="single_sidebar">
            ...
            <ul class="spost_nav">
              <li>
                <div class="media wow fadeInDown"> <a href="blogContent-bb8.php" class="media-left"> <img alt="" src="img/bb dort.jpg"> </a>
                  <div class="media-body"> <a href="blogContent-bb8.php" class="catg_title">Le sommeil de bébé</a> </div>
                </div>
              </li>
              <li>
...
<script type="text/javascript">
  $(".pagination li:nth-child(3) > a,.pagination li:nth-child(4) > a").click(function(){
    ...
    $(".single_post_content_right > ul > li:nth-child(3)").hide();
    $(".single_post_content_right > ul > li:nth-child(4)").hide();
    $(".single_post_content_right > ul > li:nth-child(5)").hide();
  ...
  $(".pagination li:nth-child(2) > a,.pagination li:nth-child(1) > a").click(function(){
    ...
    $(".single_post_content_right > ul > li:nth-child(3)").show();
    $(".single_post_content_right > ul > li:nth-child(4)").show();
    $(".single_post_content_right > ul > li:nth-child(5)").show();

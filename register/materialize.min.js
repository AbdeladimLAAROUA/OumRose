 ...
 * modified to handle properly datepicker
 */
...
Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity,
        ...
        a.fn.collapsible = function(b) {
            ...
            return b = a.extend(c, b), this.each(function() {
                function f(b) {
                    ...
                    }), d.not(b).removeClass("active").parent().removeClass("active"), d.not(b).parent().children(".collapsible-body").stop(!0, !1).each(function() {
                        a(this).is(":visible") && a(this).slideUp({
                            duration: 350,
                            easing: "easeOutQuart",
                            queue: !1,
                            complete: function() {
                                a(this).css("height", ""), i(a(this).siblings(".collapsible-header"))
                            }
                        })
                    })
                }
                ...
                function h(a) {
                    b.accordion || "accordion" === e || void 0 === e ? f(a) : g(a), i(a)
                }
                ...
                c.off("click.collapse", "> li > .collapsible-header"), d.off("click.collapse"), c.on("click.collapse", "> li > .collapsible-header", function(b) {
                    var c = a(b.target);
                    j(c) && (c = k(c)), c.toggleClass("active"), h(c)
                }), b.accordion || "accordion" === e || void 0 === e ? h(d.filter(".active").first()) : d.filter(".active").each(function() {
                    h(a(this))
                })
            })
    ...
    function(a) {
        a.fn.scrollTo = function(b) {
            ...
            return "open" === b ? (this.each(function() {
                ...
                function h() {
                    void 0 !== d.data("induration") && (e.inDuration = d.data("induration")), void 0 !== d.data("outduration") && (e.outDuration = d.data("outduration")), void 0 !== d.data("constrainwidth") && (e.constrain_width = d.data("constrainwidth")), void 0 !== d.data("hover") && (e.hover = d.data("hover")), void 0 !== d.data("gutter") && (e.gutter = d.data("gutter")), void 0 !== d.data("beloworigin") && (e.belowOrigin = d.data("beloworigin")), void 0 !== d.data("alignment") && (e.alignment = d.data("alignment")), void 0 !== d.data("stoppropagation") && (e.stopPropagation = d.data("stoppropagation"))
                }

                function i(b) {
                    "focus" === b && (f = !0), h(), g.addClass("active"), d.addClass("active"), e.constrain_width === !0 ? g.css("width", d.outerWidth()) : g.css("white-space", "nowrap");
                    var c = window.innerHeight,
                        i = d.innerHeight(),
                        j = d.offset().left,
                        k = d.offset().top - a(window).scrollTop(),
                        l = e.alignment,
                        m = 0,
                        n = 0,
                        o = 0;
                    ...
                    var p = 0,
                        q = 0,
                        r = d.parent();
                    if (r.is("body") || (r[0].scrollHeight > r[0].clientHeight && (p = r[0].scrollTop), r[0].scrollWidth > r[0].clientWidth && (q = r[0].scrollLeft)), j + g.innerWidth() > a(window).width() ? l = "right" : j - g.innerWidth() + d.innerWidth() < 0 && (l = "left"), k + g.innerHeight() > c)
                        if (k + i - g.innerHeight() < 0) {
                            var s = c - k - o;
                            g.css("max-height", s)
                        } else o || (o += i), o -= g.innerHeight();
                    if ("left" === l) m = e.gutter, n = d.position().left + m;
                    else if ("right" === l) {
                        var t = d.position().left + d.outerWidth() - g.outerWidth();
                        m = -e.gutter, n = t + m
                    }
                    g.css({
                        position: "absolute",
                        top: d.position().top + o + p,
                        left: n + q
                    }), g.stop(!0, !0).css("opacity", 0).slideDown({
                        queue: !1,
                ...
                function j() {
                    f = !1, g.fadeOut(e.outDuration), g.removeClass("active"), d.removeClass("active"), setTimeout(function() {
                        g.css("max-height", "")
                    }, e.outDuration)
                }
                var d = a(this),
                    e = a.extend({}, c, b),
                    f = !1,
                    g = a("#" + d.attr("data-activates"));
                if (h(), d.after(g), e.hover) {
                    var k = !1;
                    d.unbind("click." + d.attr("id")), d.on("mouseenter", function(a) {
                        k === !1 && (i(), k = !0)
                    }), d.on("mouseleave", function(b) {
                        var c = b.toElement || b.relatedTarget;
                        a(c).closest(".dropdown-content").is(g) || (g.stop(!0, !0), j(), k = !1)
                    }), g.on("mouseleave", function(b) {
                        var c = b.toElement || b.relatedTarget;
                        a(c).closest(".dropdown-button").is(d) || (g.stop(!0, !0), j(), k = !1)
                    })
                } else d.unbind("click." + d.attr("id")), d.bind("click." + d.attr("id"), function(b) {
                    f || (d[0] != b.currentTarget || d.hasClass("active") || 0 !== a(b.target).closest(".dropdown-content").length ? d.hasClass("active") && (j(), a(document).unbind("click." + g.attr("id") + " touchstart." + g.attr("id"))) : (b.preventDefault(), e.stopPropagation && b.stopPropagation(), i("click")), g.hasClass("active") && a(document).bind("click." + g.attr("id") + " touchstart." + g.attr("id"), function(b) {
                        g.is(b.target) || d.is(b.target) || d.find(b.target).length || (j(), a(document).unbind("click." + g.attr("id") + " touchstart." + g.attr("id")))
                    }))
                });
                d.on("open", function(a, b) {
                    i(b)
                }), d.on("close", j)
            })
        }, a(document).ready(function() {
                    ...
                    f.velocity("stop", !0), a("#materialbox-overlay").velocity("stop", !0), a(".materialbox-caption").velocity("stop", !0), a("#materialbox-overlay").velocity({
                        ...
                        complete: function() {
                            d.css({
                                ...
                                position: "",
                                "z-index": ""
                            }), f.removeClass("active"), c = !0, a(this).remove(), j && j.css("overflow", "")
                        }
                    })
                }
                if (!a(this).hasClass("initialized")) {
                    ...
                    f.wrap(g), f.on("click", function() {
                        ...
                        c = !1, f.addClass("active"), b = !0, e.css({
                            ...
                            top: 0,
                            left: 0
                        }), j = void 0, k = e[0].parentNode;
                        for (; null !== k && !a(k).is(document);) {
                            var o = a(k);
                            "visible" !== o.css("overflow") && (o.css("overflow", "visible"), j = void 0 === j ? o : j.add(o)), k = k.parentNode
                        }
                        f.css({
                            position: "absolute",
                            "z-index": 1e3
                        }).data("width", i).data("height", m);
                        var p = a('<div id="materialbox-overlay"></div>').css({
                            opacity: 0
                        }).click(function() {
                            c === !0 && l()
                        });
                        if (f.before(p), p.velocity({
                                opacity: 1
                            }, {
                                duration: d,
                                queue: !1,
                            ...
                            q.text(f.data("caption")), a("body").append(q), q.css({
                                display: "inline"
                            }), q.velocity({
                                opacity: 1
                            }, {
                        ...
                        var r = 0,
                            ...
                            u = 0,
                            v = 0;
                        s > t ? (r = m / i, u = .9 * g, v = .9 * g * r) : (r = i / m, u = .9 * h * r, v = .9 * h), f.hasClass("responsive-img") ? f.velocity({
                            "max-width": u,
                            width: i
                        }, {
                            duration: 0,
                            ...
                            complete: function() {
                                f.css({
                                    ...
                                    height: v,
                                    width: u,
                                    left: a(document).scrollLeft() + g / 2 - f.parent(".material-placeholder").offset().left - u / 2,
                                    top: a(document).scrollTop() + h / 2 - f.parent(".material-placeholder").offset().top - v / 2
                                }, {
                                    duration: d,
                                    queue: !1,
                                    easing: "easeOutQuad",
    ...
    function(a) {
        var b = {
            init: function(b) {
                ...
                return b = a.extend(c, b), this.each(function() {
                    var e, f, c = a(this),
                        g = (a(window).width(), c.find("li.tab a")),
                        h = c.width(),
                        i = Math.max(h, c[0].scrollWidth) / g.length,
                        j = 0,
                        k = function(a) {
                            return h - a.position().left - a.outerWidth() - c.scrollLeft()
                        },
                        l = function(a) {
                            return a.position().left + c.scrollLeft()
                        };
                    e = a(g.filter('[href="' + location.hash + '"]')), 0 === e.length && (e = a(this).find("li.tab a.active").first()), 0 === e.length && (e = a(this).find("li.tab a").first()), e.addClass("active"), j = g.index(e), j < 0 && (j = 0), void 0 !== e[0] && (f = a(e[0].hash)), c.append('<div class="indicator"></div>');
                    var m = c.find(".indicator");
                    c.is(":visible") && setTimeout(function() {
                        ...
                        h = c.width(), i = Math.max(h, c[0].scrollWidth) / g.length, j < 0 && (j = 0), 0 !== i && 0 !== h && (m.css({
                            right: k(e)
                        }), m.css({
                            left: l(e)
                        }))
                    }), g.not(e).each(function() {
                        a(Materialize.escapeHash(this.hash)).hide()
                    }), c.on("click", "a", function(d) {
                        if (a(this).parent().hasClass("disabled")) return void d.preventDefault();
                        if (!a(this).attr("target")) {
                            h = c.width(), i = Math.max(h, c[0].scrollWidth) / g.length, e.removeClass("active"), void 0 !== f && f.hide(), e = a(this), f = a(Materialize.escapeHash(this.hash)), g = c.find("li.tab a");
                            e.position();
                            e.addClass("active");
                            var o = j;
                            j = g.index(a(this)), j < 0 && (j = 0), void 0 !== f && (f.show(), "function" == typeof b.onShow && b.onShow.call(this, f)), j - o >= 0 ? (m.velocity({
                                right: k(e)
                            }, {
                                duration: 300,
                                queue: !1,
    ...
    function(a) {
        a.fn.tooltip = function(c) {
            ...
            return "remove" === c ? (this.each(function() {
            ...
            }), !1) : (c = a.extend(f, c), this.each(function() {
                var d = Materialize.guid(),
                    f = a(this);
                f.attr("data-tooltip-id") && a("#" + f.attr("data-tooltip-id")).remove(), f.attr("data-tooltip-id", d);
                ...
                var n = function() {
                    ...
                    return j = g ? a("<span></span>").html(j) : a("<span></span>").text(j), b.append(j).appendTo(a("body")).attr("id", d), l = a('<div class="backdrop"></div>'), l.appendTo(b), b
                };
                ...
                f.on({
                    "mouseenter.tooltip": function(a) {
                        var c = function() {
                            m(), o = !0, k.velocity("stop"), l.velocity("stop"), k.css({
                                display: "block",
                                left: "0px",
                                top: "0px"
                            });
                            var q, r, s, a = f.outerWidth(),
                                c = f.outerHeight(),
                                d = k.outerHeight(),
                                g = k.outerWidth(),
                                h = "0px",
                                ...
                                n = 8,
                                p = 8;
                            "top" === i ? (q = f.offset().top - d - e, r = f.offset().left + a / 2 - g / 2, s = b(r, q, g, d), h = "-10px", l.css({
                                bottom: 0,
                                left: 0,
                                borderRadius: "14px 14px 0 0",
                                transformOrigin: "50% 100%",
                                marginTop: d,
                                marginLeft: g / 2 - l.width() / 2
                            })) : "left" === i ? (q = f.offset().top + c / 2 - d / 2, r = f.offset().left - g - e, s = b(r, q, g, d), j = "-10px", l.css({
                                top: "-7px",
                                right: 0,
                                width: "14px",
                                height: "14px",
                                ...
                                marginTop: d / 2,
                                marginLeft: g
                            })) : "right" === i ? (q = f.offset().top + c / 2 - d / 2, r = f.offset().left + a + e, s = b(r, q, g, d), j = "+10px", l.css({
                                top: "-7px",
                                left: 0,
                                width: "14px",
                                height: "14px",
                                ...
                                marginTop: d / 2,
                                marginLeft: "0px"
                            })) : (q = f.offset().top + f.outerHeight() + e, r = f.offset().left + a / 2 - g / 2, s = b(r, q, g, d), h = "+10px", l.css({
                                top: 0,
                                left: 0,
                                marginLeft: g / 2 - l.width() / 2
                            })), k.css({
                                top: s.y,
                                left: s.x
                            }), n = Math.SQRT2 * g / parseInt(l.css("width")), p = Math.SQRT2 * d / parseInt(l.css("height")), k.velocity({
                                marginTop: h,
                                marginLeft: j
                            }, {
                                duration: 350,
                    ...
                    "mouseleave.tooltip": function() {
                        o = !1, clearTimeout(p), setTimeout(function() {
                            o !== !0 && (k.velocity({
                                opacity: 0,
                                marginTop: 0,
                                marginLeft: 0
                                ...
                                queue: !1,
                                complete: function() {
                                    l.css("display", "none"), k.css("display", "none"), o = !1
                                }
                            }))
                        }, 225)
                    }
                    ...
                    b.draggable && (e.on("click", function() {
                        ...
                        if ("touch" == c.gesture.pointerType) {
                            var g = (c.gesture.direction, c.gesture.center.x),
                                k = (c.gesture.center.y, c.gesture.velocityX, a("body")),
                                l = a("#sidenav-overlay"),
                                m = k.innerWidth();
                            if (k.css("overflow", "hidden"), k.width(m), 0 === l.length && (l = a('<div id="sidenav-overlay"></div>'), l.css("opacity", 0).click(function() {
                                    f()
                                }), a("body").append(l)), "left" === b.edge && (g > b.menuWidth ? g = b.menuWidth : g < 0 && (g = 0)), "left" === b.edge) g < b.menuWidth / 2 ? h = !1 : g >= b.menuWidth / 2 && (h = !0), d.css("transform", "translateX(" + (g - b.menuWidth) + "px)");
                            else {
                                g < window.innerWidth - b.menuWidth / 2 ? h = !0 : g >= window.innerWidth - b.menuWidth / 2 && (h = !1);
                                var n = g - b.menuWidth / 2;
                                n < 0 && (n = 0), d.css("transform", "translateX(" + n + "px)")
                            }
                            var o;
                            "left" === b.edge ? (o = g / b.menuWidth, l.velocity({
                                opacity: o
                            }, {
                                duration: 10,
                                queue: !1,
                                easing: "easeOutQuad"
                            })) : (o = Math.abs((g - window.innerWidth) / b.menuWidth), l.velocity({
                                opacity: o
                            }, {
                                duration: 10,
                                queue: !1,
    ...
    function(a) {
        ...
        function j(c) {
            ...
            var e = b.scrollTop(),
                ...
                j = g + b.width(),
                k = e + b.height(),
                l = i(e + h.top + c || 200, j + h.right, k + h.bottom, g + h.left);
        ...
        a.scrollSpy = function(d, f) {
            ...
            return e || (b.on("scroll", l), b.on("resize", l), e = !0), setTimeout(l, 0), d.on("scrollSpy:enter", function() {
        ...
        a(document).ready(function() {
            function f(b) {
                var c = b.css("font-family"),
                    e = b.css("font-size"),
                    f = b.css("line-height");
                e && d.css("font-size", e), c && d.css("font-family", c), f && d.css("line-height", f), "off" === b.attr("wrap") && d.css("overflow-wrap", "normal").css("white-space", "pre"), d.text(b.val() + "\n");
                var g = d.html().replace(/\n/g, "<br>");
                d.html(g), b.is(":visible") ? d.css("width", b.width()) : d.css("width", a(window).width() / 2), b.css("height", d.height())
            }
            ...
            var c = "input[type=radio], input[type=checkbox]";
            a(document).on("keyup.radio", c, function(b) {
                if (9 === b.which) {
            ...
            a(document).on("change", g, function(b) {
                ...
                c.length <= 0 && (c = a('<span class="thumb"><span class="value"></span></span>'), a(this).after(c)), c.find(".value").html(a(this).val()), h = !0, a(this).addClass("active"), c.hasClass("active") || c.velocity({
                    ...
                    duration: 300,
                    easing: "easeOutExpo"
                }), "input" !== b.type && (i = void 0 === b.pageX || null === b.pageX ? b.originalEvent.touches[0].pageX - a(this).offset().left : b.pageX - a(this).offset().left, i < 0 ? i = 0 : i > d && (i = d), c.addClass("active").css("left", i)), c.find(".value").html(a(this).val())
                ...
                if (h) {
                    ...
                    d < 0 ? d = 0 : d > e && (d = e), c.addClass("active").css("left", d), c.find(".value").html(c.siblings(g).val())
                }
        ...
        var b = {
            init: function(b) {
                ...
                return b = a.extend(c, b), this.each(function() {
                    ...
                    function k(a) {
                        a >= e.length ? a = 0 : a < 0 && (a = e.length - 1), f = d.find(".active").index(), f != a && (g = e.eq(f), $caption = g.find(".caption"), g.removeClass("active"), g.velocity({
                            opacity: 0
                        }, {
                        ...
                        }), j($caption, b.transition), b.indicators && h.eq(f).removeClass("active"), e.eq(a).velocity({
                            opacity: 1
                        }, {
                            duration: b.transition,
                            queue: !1,
                            easing: "easeOutQuad"
                        }), e.eq(a).find(".caption").velocity({
                            opacity: 1,
                            translateX: 0,
                            translateY: 0
                        }, {
                            ...
                            queue: !1,
                            easing: "easeOutQuad"
                        }), e.eq(a).addClass("active"), b.indicators && h.eq(a).addClass("active"))
                    }
                    var g, h, i, c = a(this),
                        d = c.find("ul.slides").first(),
                        e = d.find("> li"),
                        f = d.find(".active").index();
                    f != -1 && (g = e.eq(f)), c.hasClass("fullscreen") || (b.indicators ? c.height(b.height + 40) : c.height(b.height), d.height(b.height)), e.find(".caption").each(function() {
                        j(a(this), 0)
                    ...
                    }), b.indicators && (h = a('<ul class="indicators"></ul>'), e.each(function(c) {
                        var g = a('<li class="indicator-item"></li>');
                        g.click(function() {
                            var c = d.parent(),
                                g = c.find(a(this)).index();
                            k(g), clearInterval(i), i = setInterval(function() {
                                f = d.find(".active").index(), e.length == f + 1 ? f = 0 : f += 1, k(f)
                            }, b.transition + b.interval)
                        }), h.append(g)
                    }), c.append(h), h = c.find("ul.indicators").find("li.indicator-item")), g ? g.show() : (e.first().addClass("active").velocity({
                        opacity: 1
                    }, {
                        duration: b.transition,
                        queue: !1,
                        easing: "easeOutQuad"
                    }), f = 0, g = e.eq(f), b.indicators && h.eq(f).addClass("active")), g.find("img").each(function() {
                    ...
                    c.hammer({
                        ...
                        if ("touch" === a.gesture.pointerType) {
                            ...
                            $curr_slide = d.find(".active"), $curr_slide.velocity({
                                ...
                                queue: !1,
                                easing: "easeOutQuad"
                            }), 4 === b && (f > c.innerWidth() / 2 || g < -.65) ? n = !0 : 2 === b && (f < -1 * c.innerWidth() / 2 || g > .65) && (m = !0);
                            var h;
                        ...
                        "touch" === a.gesture.pointerType && ($curr_slide = d.find(".active"), l = !1, curr_index = d.find(".active").index(), !n && !m || e.length <= 1 ? $curr_slide.velocity({
                            translateX: 0
                        }, {
                            duration: 300,
                            queue: !1,
                            easing: "easeOutQuad"
                        }) : m ? (k(curr_index + 1), $curr_slide.velocity({
                            translateX: -1 * c.innerWidth()
                        }, {
                            duration: 300,
                            queue: !1,
                            easing: "easeOutQuad",
                        ...
                        })) : n && (k(curr_index - 1), $curr_slide.velocity({
                            translateX: c.innerWidth()
                        }, {
                            duration: 300,
                            queue: !1,
                            easing: "easeOutQuad",
                        ...
                        })), m = !1, n = !1, clearInterval(i), i = setInterval(function() {
                            f = d.find(".active").index(), e.length == f + 1 ? f = 0 : f += 1, k(f)
                        }, b.transition + b.interval))
                    }), c.on("sliderPause", function() {
                        clearInterval(i)
                    }), c.on("sliderStart", function() {
                        clearInterval(i), i = setInterval(function() {
                            f = d.find(".active").index(), e.length == f + 1 ? f = 0 : f += 1, k(f)
                        }, b.transition + b.interval)
                    }), c.on("sliderNext", function() {
                        f = d.find(".active").index(), k(f + 1)
                    }), c.on("sliderPrev", function() {
                        f = d.find(".active").index(), k(f - 1)
                    })
                })
            },
            ...
            this.init = function() {
                ...
                e.$document.off("click.chips-focus", b.CHIPS).on("click.chips-focus", b.CHIPS, function(c) {
                    ...
                    if (!a(c.target).is("input, textarea")) {
                        var h, d = e.$document.find(b.CHIP + b.SELECTED_CHIP),
                            f = d.closest(b.CHIPS),
                            g = d.siblings(b.CHIP).length;
                        if (d.length)
                            if (8 === c.which || 46 === c.which) {
                                c.preventDefault(), h = d.index(), e.deleteChip(h, f);
                                var i = null;
                                h + 1 < g ? i = h : h !== g && h + 1 !== g || (i = g - 1), i < 0 && (i = null), null !== i && e.selectChip(i, f), g || f.find("input").focus()
                            } else if (37 === c.which) {
                            if (h = d.index() - 1, h < 0) return;
                            a(b.CHIP).removeClass("selected"), e.selectChip(h, f)
                        } else if (39 === c.which) {
                            if (h = d.index() + 1, a(b.CHIP).removeClass("selected"), h > g) return void f.find("input").focus();
                            e.selectChip(h, f)
                        }
                    }
        ...
        a.fn.pushpin = function(b) {
            ...
            return "remove" === b ? (this.each(function() {
                ...
                var c = Materialize.guid(),
                    d = a(this),
                    e = a(this).offset().top;
                a(this).data("pushpin-id", c), g(d, a(window).scrollTop()), a(window).on("scroll." + c, function() {
    ...
    function(a) {
        ...
        var b = function(b) {
                ...
                if (c.hasClass("active") === !1) {
                    var e, f, d = c.hasClass("horizontal");
                    d === !0 ? f = 40 : e = 40, c.addClass("active"), c.find("ul .btn-floating").velocity({
                        scaleY: ".4",
                        scaleX: ".4",
                        translateY: e + "px",
                        translateX: f + "px"
            ...
            c = function(a) {
                var d, e, b = a,
                    c = b.hasClass("horizontal");
                c === !0 ? e = 40 : d = 40, b.removeClass("active");
        ...
        function e(b, i, j, l) {
            ...
            function u() {
                q.data(i, s).addClass(p.input).attr("tabindex", -1).val(q.data("value") ? s.get("select", o.format) : b.value), o.editable || q.on("focus." + n.id + " click." + n.id, function(a) {
                    a.preventDefault(), s.$root.eq(0).focus()
            ...
            function v() {
                s.$root.on({
                    ...
                    "mousedown click": function(b) {
                        var c = b.target;
                        c != s.$root.children()[0] && (b.stopPropagation(), "mousedown" != b.type || a(c).is("input, select, textarea, button, option") || (b.preventDefault(), s.$root.eq(0).focus()))
                    }
                }).on({
                    focus: function() {
                        q.addClass(p.target)
                    ...
                    var b = a(this),
                        ...
                        e = k();
                    e = e && (e.type || e.href), (d || e && !a.contains(s.$root[0], e)) && s.$root.eq(0).focus(), !d && c.nav ? s.set("highlight", s.component.item.highlight, {
                        nav: c.nav
                    }) : !d && "pick" in c ? s.set("select", c.pick).close(!0) : c.clear ? s.clear().close(!0) : c.close && s.close(!0)
                }), h(s.$root[0], "hidden", !0)
            }
            ...
            var m = !1,
                ...
                s = r.prototype = {
                    ...
                    open: function(f) {
                        ...
                        }, 0), f !== !1 && (n.open = !0, m && d.css("overflow", "hidden").css("padding-right", "+=" + g()), s.$root.eq(0).focus(), c.on("click." + n.id + " focusin." + n.id, function(a) {
                            var c = a.target;
                    ...
                    close: function(a) {
                        return a && (s.$root.off("focus.toOpen").eq(0).focus(), setTimeout(function() {
    ...
    function(a) {
        ...
        function f(a, b) {
            ...
            }(c.item.disable), c.set("min", b.min).set("max", b.max).set("now"), g ? c.set("select", null).set("highlight", g, {
                format: h
    ...
    function(a) {
        var b = {
            init: function(b) {
                ...
                return b = a.extend(c, b), this.each(function() {
                    function x() {
                        "undefined" != typeof window.ontouchstart && (u[0].addEventListener("touchstart", H), u[0].addEventListener("touchmove", I), u[0].addEventListener("touchend", J)), u[0].addEventListener("mousedown", H), u[0].addEventListener("mousemove", I), u[0].addEventListener("mouseup", J), u[0].addEventListener("mouseleave", J), u[0].addEventListener("click", F)
                    }
                    ...
                    function B(a) {
                        return a >= h ? a % h : a < 0 ? B(h + a % h) : a
                    }

                    function C(a) {
                        var f, i, j, k, l, m, o;
                        if (d = "number" == typeof a ? a : d, e = Math.floor((d + g / 2) / g), j = d - e * g, k = j < 0 ? 1 : -1, l = -k * j * 2 / g, i = h >> 1, b.full_width ? o = "translateX(0)" : (o = "translateX(" + (u[0].clientWidth - item_width) / 2 + "px) ", o += "translateY(" + (u[0].clientHeight - item_width) / 2 + "px)"), v) {
                            var q = e % h,
                                r = t.find(".indicator-item.active");
                            r.index() !== q && (r.removeClass("active"), t.find(".indicator-item").eq(q).addClass("active"))
                        }
                        for ((!b.no_wrap || e >= 0 && e < h) && (m = c[B(e)], m.style[n] = o + " translateX(" + -j / 2 + "px) translateX(" + k * b.shift * l * f + "px) translateZ(" + b.dist * l + "px)", m.style.zIndex = 0, b.full_width ? tweenedOpacity = 1 : tweenedOpacity = 1 - .2 * l, m.style.opacity = tweenedOpacity, m.style.display = "block"), f = 1; f <= i; ++f) b.full_width ? (zTranslation = b.dist, tweenedOpacity = f === i && j < 0 ? 1 - l : 1) : (zTranslation = b.dist * (2 * f + l * k), tweenedOpacity = 1 - .2 * (2 * f + l * k)), (!b.no_wrap || e + f < h) && (m = c[B(e + f)], m.style[n] = o + " translateX(" + (b.shift + (g * f - j) / 2) + "px) translateZ(" + zTranslation + "px)", m.style.zIndex = -f, m.style.opacity = tweenedOpacity, m.style.display = "block"), b.full_width ? (zTranslation = b.dist, tweenedOpacity = f === i && j > 0 ? 1 - l : 1) : (zTranslation = b.dist * (2 * f - l * k), tweenedOpacity = 1 - .2 * (2 * f - l * k)), (!b.no_wrap || e - f >= 0) && (m = c[B(e - f)], m.style[n] = o + " translateX(" + (-b.shift + (-g * f - j) / 2) + "px) translateZ(" + zTranslation + "px)", m.style.zIndex = -f, m.style.opacity = tweenedOpacity, m.style.display = "block");
                        (!b.no_wrap || e >= 0 && e < h) && (m = c[B(e)], m.style[n] = o + " translateX(" + -j / 2 + "px) translateX(" + k * b.shift * l + "px) translateZ(" + b.dist * l + "px)", m.style.zIndex = 0, b.full_width ? tweenedOpacity = 1 : tweenedOpacity = 1 - .2 * l, m.style.opacity = tweenedOpacity, m.style.display = "block")
                    }

                    function D() {
                        var a, b, c, e;
                        a = Date.now(), b = a - p, p = a, c = d - o, o = d, e = 1e3 * c / (1 + b), m = .8 * e + .2 * m
                    }

                    function E() {
                        var a, c;
                        k && (a = Date.now() - p, c = k * Math.exp(-a / b.time_constant), c > 2 || c < -2 ? (C(l - c), requestAnimationFrame(E)) : C(l))
                    }

                    function F(c) {
                        if (r) return c.preventDefault(), c.stopPropagation(), !1;
                        if (!b.full_width) {
                            var d = a(c.target).closest(".carousel-item").index(),
                                f = e % h - d;
                            0 !== f && (c.preventDefault(), c.stopPropagation()), G(d)
                        }
                    }

                    function G(a) {
                        var c = e % h - a;
                        b.no_wrap || (c < 0 ? Math.abs(c + h) < Math.abs(c) && (c += h) : c > 0 && Math.abs(c - h) < c && (c -= h)), c < 0 ? u.trigger("carouselNext", [Math.abs(c)]) : c > 0 && u.trigger("carouselPrev", [c])
                    }

                    function H(a) {
                        f = !0, r = !1, s = !1, i = z(a), j = A(a), m = k = 0, o = d, p = Date.now(), clearInterval(q), q = setInterval(D, 100)
                    }

                    function I(a) {
                        var b, c, e;
                        if (f)
                            if (b = z(a), y = A(a), c = i - b, e = Math.abs(j - y), e < 30 && !s)(c > 2 || c < -2) && (r = !0, i = b, C(d + c));
                            else {
                                if (r) return a.preventDefault(), a.stopPropagation(), !1;
                                s = !0
                            }
                        if (r) return a.preventDefault(), a.stopPropagation(), !1
                    }
                    ...
                    function J(a) {
                        if (f) return f = !1, clearInterval(q), l = d, (m > 10 || m < -10) && (k = .9 * m, l = d + k), l = Math.round(l / g) * g, b.no_wrap && (l >= g * (h - 1) ? l = g * (h - 1) : l < 0 && (l = 0)), k = l - d, p = Date.now(), requestAnimationFrame(E), r && (a.preventDefault(), a.stopPropagation()), !1
                    }
                    var c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t = a('<ul class="indicators"></ul>'),
                        u = a(this),
                        v = u.attr("data-indicators") || b.indicators;
                    if (u.hasClass("initialized")) return a(this).trigger("carouselNext", [1e-6]), !0;
                    if (b.full_width) {
                        b.dist = 0;
                        var w = u.find(".carousel-item img").first();
                        w.length ? imageHeight = w.on("load", function() {
                            u.css("height", a(this).height())
                        }) : (imageHeight = u.find(".carousel-item").first().height(), u.css("height", imageHeight)), v && u.find(".carousel-fixed-item").addClass("with-indicators")
                    }
                    u.addClass("initialized"), f = !1, d = l = 0, c = [], item_width = u.find(".carousel-item").first().innerWidth(), g = 2 * item_width + b.padding, u.find(".carousel-item").each(function(b) {
                        if (c.push(a(this)[0]), v) {
                            var d = a('<li class="indicator-item"></li>');
                            0 === b && d.addClass("active"), d.click(function() {
                                var b = a(this).index();
                                G(b)
                            }), t.append(d)
                        }
                    }), v && u.append(t), h = c.length, n = "transform", ["webkit", "Moz", "O", "ms"].every(function(a) {
                        var b = a + "Transform";
                        return "undefined" == typeof document.body.style[b] || (n = b, !1)
                    }), window.onresize = C, x(), C(d), a(this).on("carouselNext", function(a, b) {
                        void 0 === b && (b = 1), l = d + g * b, d !== l && (k = l - d, p = Date.now(), requestAnimationFrame(E))

    ...
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="slick_slider">
          <div class="single_iteam">  <img src="img/repas bb.jpg" alt="">
          </div>
        </div>
      </div>
  ...
  <section id="contentSection">
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-8 content">
        <h2>Checklist équipement repas de bébé</h2>

        <p>Quand bébé prend le sein :</p>
         <ul>
           <li>Coussinets d’allaitement</li>
           <li>Tire lait</li>
           <li>Pot de conservation</li>
        </ul>


         <p>Quand bébé prend le biberon :</p>
         <ul>
           <li>Biberons</li>
           <li>Tétines</li>
           <li>Stérilisateur</li>
           <li>Egoutte biberon</li>
           <li>Chauffe biberon</li>
           <li>Bavoirs</li>
           <li>Boite doseuse de lait en poudre</li>
        </ul>


         <p>Quand bébé mange :</p>
         <ul>
           <li>Chaise haute</li>
           <li>Robot cuiseur mixeur</li>
           <li>Couverts</li>
           <li>Assiettes</li>
           <li>Tasses avec poignée</li>
           <li>Biberons à bec</li>
           <li>Bavoirs</li>
        </ul>

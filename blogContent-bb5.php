...
<meta name="viewport" content="width=device-width, initial-scale=1">
    <meta property="og:title" content="Checklist sécurité de bébé à la maison">
    <meta property="og:image" content="http://beta.oumbox.com/img/security.jpg">
    <meta property="og:url" content="http://beta.oumbox.com/blogContent-bb5.php">
    ...
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="slick_slider">
          <div class="single_iteam"> <img src="img/security.jpg" alt="">
          </div>
        </div>
      </div>
  ...
  <section id="contentSection">
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-8 content">
        <h2>Checklist sécurité de bébé à la maison</h2>

        <p>
          Mettez-vous à la place d'un bébé qui rampe ou qui commence à marcher, et vous serez effrayée de voir les dangers qui l'entourent. Alors équipez-vous, et surtout, ne laissez jamais votre enfant seul sans surveillance.
        </p>
       
        <ul>
          <li>Barrières de sécurités (à placer dans tous les endroits à risque: cuisine, escalier, salle de bain, terrasse, piscine...)</li>
          <li>Bloque-porte</li>
          <li>Bloque-fenêtre</li>
          <li>Bloque-tiroir</li>
          <li>Protège coins de table</li>
          <li>Cache prise</li>
          <li>Détecteur de fumée</li>
          <li>Sécurisez votre piscine en y bloquant l'accés</li>
        </ul>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-4">

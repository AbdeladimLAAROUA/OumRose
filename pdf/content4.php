...
<table border="0" align="center" width="100%" cellpadding="0" cellspacing="0" class="main-template" bgcolor="#ffffff" style="background-color:#ffffff;">
    ...
    <tbody><tr style="display:none !important; font-size:1px; mso-hide: all;"><td></td></tr>
    <tr>
        ...
        <!--[if gte mso 9]>
                        ...
                        <![endif]-->
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer" style="max-width:1200px!important; width: 590px;">
        <tbody><tr>
                            ...
                            <tr>
                                <td align="center" height="20" style="font-size: 13px; color: rgb(255, 255, 255); font-weight: normal; text-align: center; font-family: Arial, Helvetica, sans-serif;">
                                    <span style="color: rgb(255, 255, 255); text-decoration: none;">
                                        <a target="_blank" href="[MIRROR]" style="text-decoration: none; color: rgb(255, 255, 255);">View in browser</a></span>
                                </td>
                            </tr>
                            <tr>
                                <td height="10" style="font-size:1px; line-height:1px;">&nbsp;</td>
                                                ...
                                                <table border="0" valign="top" cellspacing="0" cellpadding="0" align="left" class="rnb-col-1" width="550">
                                                    <tbody><tr>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <div style="border-top:0px None #9c9c9c;border-right:0px None #9c9c9c;border-bottom:0px None #9c9c9c;border-left:0px None #9c9c9c;display:inline-block;">
                                                                            ...
                                                                            <img width="301" border="0" hspace="0" vspace="0" class="rnb-col-1-img" alt="OUMBOX" src="http://img.mailinblue.com/1614237/images/rnb/original/58e17b65140ba06e448b473e.png" style="vertical-align: top; max-width: 301px; position:relative;left:220px"></a>
                                                                            </div></td>
                                                                            </tr>
                                                                        </tbody></table>
                                                        ...
                                                        <td style="font-size:14px; font-family:'Arial',Helvetica,sans-serif, sans-serif; color:#555;">
                                                            <div><div><span style="font-size:14px;">Chère&nbsp; {PRENOM},</span></div>
...
<ul>
    ...
    <li><span style="font-size:14px;"><span style="background-color: transparent;"><strong>NOM:</strong>&nbsp;{NOM} &nbsp; &nbsp;&nbsp;<strong>PRENOM:&nbsp;</strong></span></span> {PRENOM}</li>
    <li><span style="font-size:14px;"><span style="background-color: transparent;"><strong>DATE DE NAISSANCE:</strong> {DATE_NAISSANCE}</span></span></li>
    <li><strong>CODE OUMBOX:&nbsp;</strong> {ID}</li>
...
<div style="text-align: right;"><em>&nbsp;CODE: 17</em>06OX{ID}</div>
</div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                ...
                <tbody><tr>
                    <td class="rnb-del-min-width" align="center" valign="top" bgcolor="#555" style="min-width:590px; background-color: #555;">
                        <table width="590" class="rnb-container" cellpadding="0" border="0" align="center" cellspacing="0" style="padding-right:20px; padding-left:20px;">
                            ...
                            <tr>
                                <td>
                                    <div style="font-size:14px; color:#919191; font-weight:normal; text-align:center; font-family:Arial,Helvetica,sans-serif;"><div><span style="color:#D3D3D3;">This email was sent to {EMAIL} </span>

<div><span style="color:#D3D3D3;">You received this email because you are registered with Oumbox</span></div>
...
<div><span style="color:#696969;">&nbsp;</span></div>
                                    ...
                                    <div style="font-size:14px; font-weight:normal; text-align:center; font-family:Arial,Helvetica,sans-serif;">
                                        <a style="text-decoration:none; color:#ccc;font-size:14px;font-weight:normal;font-family:Arial,Helvetica,sans-serif;" target="_blank" href="[UNSUBSCRIBE]">Unsubscribe here</a></div>
                                </td></tr>
                            <tr>
                                <td height="10" style="font-size:1px; line-height:1px;">&nbsp;</td>
                            </tr>
                ...
                <tbody><tr>
                    <td class="rnb-del-min-width" align="center" valign="top" bgcolor="#333" style="min-width:590px; background-color: #333;">
                        <table width="590" class="rnb-container rnb-yahoo-width" cellpadding="0" border="0" align="center" cellspacing="0" style="padding-right:20px; padding-left:20px;">
                            ...
                            <tr>
                                <td style="font-size:14px; color:#d63ad6; font-weight:normal; text-align:center; font-family:Arial,Helvetica,sans-serif;">
                                    <div><div>© 2017 OUMBOX</div>
</div>
                                </td></tr>
                            <tr>
                                <td height="20" style="font-size:1px; line-height:1px;">&nbsp;</td>

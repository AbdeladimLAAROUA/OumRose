    ...
    <div class="alert alert-info col-md-12 col-sm-12 col-xs-12 content">
        ...
        <div class="commandeDetails">
          <table>
            <tr>
              <td>Client</td>
              <td><span class="infoLivraison"><?php echo $_SESSION['nomComplet']; ?></span></td>
            </tr> 

            <tr>
              <td>Type de livraison</td>
              <td><span class="infoLivraison">Oumbox</span></td>
            </tr> 

            <tr>
              <td>Ville</td>
              <td><span class="infoLivraison">Casablanca</span></td>
            </tr>

            <tr>
              <td>Adresse </td>
              <td><span class="infoLivraison">77 bis, boulevard abdelmoumen</span></td>
            </tr>

            <tr>
              <td>Téléphone</td>
              <td><span class="infoLivraison">05 22 22 58 50</span></td>
            </tr>
          </table>
